...
SECRET_KEY = 'django-insecure-kjvk_krv@4gg^3nfow_)^*j5%p0(k#lfn+mj*we#m=)w1%!&nu'
...
STATIC_URL = '/static/'
MEDIA_URL = '/media/' # new for upload
MEDIA_ROOT = BASE_DIR / 'media' # new for upload location
